...
class Acudientes extends CI_Controller {
	...
	public function Solicitudes(){
		...
		$this->data			=		$Configuracion->TipoDocumentos();
		$this->Solicitudes	=		$Configuracion->TodasLasSolicitudes();
		$this->util->exec();
	}

	// public function Plan_de_tareas(){
	// 	redirect(base_url("Apanel/Acudientes?m=Evaluaciones"));	return;
	// }
	...
	public function Mensajes(){
		//redirect(base_url("Apanel/Acudientes?m=Comunicaciones"));	return;
		$this->util->skipBtnAdd();
		$this->util->exec();
	}
